...
export default function MehndiCard({
    position = [0, 0, 0],
    rotationY = 0,
    width = 1.7,
    height = 2.2,
    ...
    const texture = useTexture(MEHNDI_IMAGE);
